Feature: Create Campaign Flash Sale Percent
  ...
  Scenario: Create Campaign Flash Sale Percent
    ##Loigin CMS page
    ##Loigin CMS page
    Given I open internal page
    ...
    And I select campaign type "Flash sale" on the Internal Marketing List Campaign page
    ...
    And I select time flash sale on the Internal Marketing List Campaign Ticket page
    And I select pricing product name on the Internal Marketing List Campaign Ticket page
    And I select sale type "Giảm %" on the Internal Marketing List Campaign Ticket page
