Feature: Seller Add Combo
  ...
  Scenario: Seller Add Combo
    Given I open Seller page
    ##Click Menu
    And I click menu "Kênh marketing" on the Seller Home page
    And I click menu "Danh sách combo" on the Seller Home page
    And I click button add combo on the Seller Home page
    And I enters combo name on the Seller Home page
    And I enters combo code on the Seller Home page
    And I upload image combo on the Seller Home page
    And I select product on the Seller Home page
    And I enters ammount product on the Seller Home page
    And I click add product button on the Seller Home page
    And I select discount type "Giảm giá tuyệt đối" on the Seller Home page
    And I enters price discount on the Seller Home page
    And I create combo button on the Seller Home page
    #Post for sale Seller
    Given I open new tab
    When I open internal page
    And I click menu seller button on the Internal Home page
    And I click sub menu request approve button on the Internal Seller page
    And I click status pending approve button on the Internal Seller page
    And I enters combo name on the Internal Seller page
    And I click apply button on the Internal Seller page
    And I click checkbox item product on the Internal Seller page
    And I click view detail item product on the Internal Seller page
    And I click accept button on the Internal Seller page
